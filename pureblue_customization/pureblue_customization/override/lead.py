...
#         logo_url = frappe.utils.get_url("/files/pureblue-meds-logo.png")
#         logo_img = logo_url
...
#                 <div class="header">
#                     <div class="logo">
#                         <img src="{logo_img}" alt="Pure Blue Meds Logo">
#                     </div>
...
def send_brochure_email(doc_name, doctype_name):
    try:
        ...
        recipient_email = doc.email_id or doc.email or doc.contact_email
        if not recipient_email:
            frappe.throw("Email address not found")
        ...
        frappe.log_error(frappe.get_traceback(), "Brochure Email Error")
        frappe.throw("Failed to send brochure email")
